            ...
            <div class="middle_box">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm" label-position="top">
                    <el-row :gutter="24">
                        ...
                        <el-col :sm="8" :md="8" :lg="8" :xl="8" :xs="24">
                            <el-form-item label="ID No.(NRIC/FIN)" prop="IDNo">
                                <el-input v-model="ruleForm.IDNo" clearable placeholder="Please Input Your ID No.(NRIC/FIN)"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="24">
    ...
    data() {
        ...
        var validatePassword = (rule, value, callback) => {
            if (value === '') {
                ...
                callback(new Error('The password cannot contain a ID No.(NRIC/FIN), Please reset your password'));
        ...
        return {
            ...
            rules: {
                ...
                IDNo: [{ required: true, message: 'Please enter your ID No.(NRIC/FIN)' }],
                ...
                MobileNumber: [
                    { required: true, message: 'Please enter your Mobile Number', trigger: ['blur', 'change'] },
                    { pattern: PHONE_REG, message: 'Please enter your right Mobile Number', trigger: ['blur', 'change'] }
                ],
                EmailAddress: [
                ...
                (res) => {
                    if (res.status == 200) {
                        if (res.data.code === 0) {
                            ...
                            this.CitizenshipSelect = sortArrayByFirstLetter(citizenshipList);
